module.exports = async function () {
    ...
    // load SP_ALL
    var Search = fs.readFileSync("./app/scraping/SP_all.json");
    var fileSearch = JSON.parse(Search);

    // load interest points
    var Points = fs.readFileSync("./app/points/interestpoints.json");
    ...
    fs.writeFile("./app/scoring/" + filename + ".json", JSON.stringify(results), function (err) {
